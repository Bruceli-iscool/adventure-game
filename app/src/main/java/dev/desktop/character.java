...
Thread.sleep(500);
    ...
    Thread.sleep(200);
    System.out.println("The doors open, you see the emperor his face with wrinkles. 1 to say \"Your Majesty! it is an honor to meet you!\" or 2 (or any other key) to say \"What is it emperor?\"");
    n = App.ask(">");
    if ("1".equals(n)) {
        System.out.println();
    } else {
